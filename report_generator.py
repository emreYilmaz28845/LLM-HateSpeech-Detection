# report_generator.py - puts together the final report and summary files
...
def generate_markdown_report(results_df, metrics=None, output_path=None):
    """
    builds a markdown report with everything in one place
    """
...
def generate_summary_table(results_df, metrics=None, output_path=None):
    """
    spits out a csv with the main metrics for quick reference
    """
...
def generate_all_reports(results_df):
    """
    kicks off both report builders
    """
    print("\n" + "="*50)
